...
(
    <>
        <article className="flex flex-col w-full lg:mt-[3rem] py-[2rem] lg:pt-[8rem] lg:pb-[6rem] gap-[3rem] md:gap-[8rem] ">
            ...
            {staticImage2 && (
                <div className="h-[300px] md:h-screen w-full bg-center bg-contain md:bg-cover bg-no-repeat max-md:my-[1.75rem] my-[4rem]" style={{ backgroundImage: `url(${staticImage2})` }}></div>
            )}
